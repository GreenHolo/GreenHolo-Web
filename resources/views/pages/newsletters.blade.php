        ...
        <div class="flex -mx-1">
            <div class="w-full mx-auto sm:w-full md:w-3/5 lg:w-3/5 xl:w-3/5 mx-1 p-3 rounded-lg" style="height: auto;">
                <div class="bg-white p-3 -m-3 rounded-lg">
                    <p class="text-lg text-gray-500 font-medium">Newsletters</p>
                </div>
                <div class="bg-white p-4 my-6 -m-3 rounded-lg">
                    <div class="flex items-center">
                        <div class="flex items-center">
                            ...
                            <div class="mx-4">
                                <p class="text-green-700 text-xl font-bold">#Newsletter 1</p>
                            </div>
                        </div>
                        <div class="ml-auto">
                            <a class="py-2 px-6 border-2 border-red-200 text-red-700 rounded-full font-bold" href="">Unsubscribe</a>
                        </div>
                    </div>
